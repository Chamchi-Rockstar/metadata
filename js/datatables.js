 ...
 *   https://datatables.net/download/#dt/dt-2.3.5/cr-2.1.2/fc-5.0.5/fh-4.0.5/r-3.0.7
 *
 * Included libraries:
 *   DataTables 2.3.5, ColReorder 2.1.2, FixedColumns 5.0.5, FixedHeader 4.0.5, Responsive 3.0.7
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "dt/dt-2.3.5/cr-2.1.2/fc-5.0.5/fh-4.0.5/r-3.0.7",
